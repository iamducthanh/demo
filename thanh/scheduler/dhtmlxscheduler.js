...
(window.dhtmlXScheduler = window.scheduler = { version: "4.3.25" }),
      ...
      ((window[e] = function (e) {
        ...
        if (e && "object" == typeof e && !e.tagName) {
          ...
          for (var a in e)
            t[a]
              ? this[t[a]](e[a])
              : 0 === a.indexOf("on") && this.attachEvent(a, e[a]);
  ...
  (dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function (e) {
    ...
    for (var i = 0; i < e.childNodes.length; i++) {
      ...
      s &&
        (t[s] || (t[s] = []), t[s].push(this.xmlNodeToJSON(e.childNodes[i])));
    }
    return t;
  }),
  ...
  (dhtmlDragAndDropObject.prototype.initFrameRoute = function (e, t) {
    ...
    for (var s = 0; s < window.frames.length; s++)
      try {
        window.frames[s] != e &&
          window.frames[s].dhtmlDragAndDrop &&
          window.frames[s].dhtmlDragAndDrop.initFrameRoute(
            window,
            !e || t ? 1 : 0
          );
      } catch (i) {}
  ...
  (dtmlXMLLoaderObject.prototype.doXPathOpera = function (e, t) {
    ...
    if ("." == i[0]) s = [t];
      ...
      if ("" !== i[0]) return [];
      (s = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(
        i[a].replace(/\[[^\]]*\]/g, "")
      )),
        a++;
    }
    ...
    return (
      -1 != i[a - 1].indexOf("[") && (s = this._filterXPath(s, i[a - 1])), s
    );
  }),
  ...
  (dtmlXMLLoaderObject.prototype._getAllNamedChilds = function (e, t) {
    ...
    for (var s = 0; s < e.length; s++)
      for (var a = 0; a < e[s].childNodes.length; a++)
        _isKHTML
          ? e[s].childNodes[a].tagName &&
            e[s].childNodes[a].tagName.toUpperCase() == t &&
            (i[i.length] = e[s].childNodes[a])
          : e[s].childNodes[a].tagName == t &&
            (i[i.length] = e[s].childNodes[a]);
    return i;
  }),
  ...
  (function () {
    ...
    function t(t) {
      if (c) {
        ...
        return (
          dhtmlx.message.keyboard &&
            ((13 == i || 32 == i) && e(c, !0), 27 == i && e(c, !1)),
    ...
    function n(t, i, a) {
      ...
      if (
        ...
        t.title &&
          (r += '<div class="dhtmlx_popup_title">' + t.title + "</div>"),
        (r +=
          '<div class="dhtmlx_popup_text"><span>' +
          (t.content ? "" : t.text) +
    ...
    function r(e, s, a) {
      ...
      return (
        "top" == e.position ? (r.style.top = "-3px") : (r.style.top = o + "px"),
        (r.style.left = d + "px"),
        (r.onkeydown = t),
        r.focus(),
    ...
    function _(e, t, i, s) {
      return (
        "object" != typeof e && (e = { text: e, type: t, expire: i, id: s }),
        (e.id = e.id || u.uid()),
  ...
  (dataProcessor.prototype = {
    ...
    markRow: function (e, t, i) {
      var s = "",
        a = this.is_invalid(e);
      if (
        (a && ((s = this.styles[a]), (t = !0)),
        this.callEvent("onRowMark", [e, t, i, a]) &&
          ((s = this.styles[t ? i : "clear"] + s),
    ...
    serialize: function (e, t) {
      ...
      for (var a in e)
        e.hasOwnProperty(a) &&
          (i.push(this.serialize_one(e[a], a + this.post_delim)), s.push(a));
      return (
      ...
      if (e) {
        ...
        var i = new dtmlXMLLoaderObject(
          ...
          s =
            ...
            (this._user
              ? getUrlSymbol(this.serverProcessor) +
                [
                  "dhx_user=" + this._user,
        ...
        if ("GET" == this._tMode)
          i.loadXML(
            s + (-1 != s.indexOf("?") ? "&" : "?") + this.serialize(e, t)
          );
          ...
          "inserted" == a
            ? i.loadXML(n + t, "POST", this.serialize(e, t))
            : "deleted" == a
            ? i.loadXML(n + t, "DELETE", "")
            : i.loadXML(n + t, "PUT", this.serialize(e, t));
        }
        this._waitMode++;
      }
    },
      ...
      for (var t = {}, i = !1, s = 0; s < this.updatedRows.length; s++) {
        ...
        this._in_progress[a] ||
          ...
          (this.callEvent("onBeforeUpdate", [
            ...
            ((t[a] = this._getRowData(a, a + this.post_delim)),
            (i = !0),
    ...
    afterUpdateCallback: function (e, t, i, s) {
      ...
      "wait" != this._in_progress[a]
        ? (n && this.obj.setUserData(e, this.action_param, ""),
          delete this._in_progress[a])
        : (delete this._in_progress[a],
    ...
    afterUpdate: function (e, t, i) {
      ...
      if ((t.getXMLTopNode("data"), !t.xmlDoc.responseXML))
        return (
          this.obj &&
            this.obj.callEvent &&
            this.obj.callEvent("onSaveError", [i, t.xmlDoc]),
          this.cleanUpdate(i)
        );
    ...
    loadUpdate: function () {
      var e = this,
        ...
        i =
          this.serverProcessor +
          getUrlSymbol(this.serverProcessor) +
          ["dhx_user=" + this._user, "dhx_version=" + t].join("&");
    ...
    dhtmlxEventable(scheduler),
      ...
      (scheduler.set_xy = function (e, t, i, s, a) {
        (e.style.width = Math.max(0, t) + "px"),
          ...
          arguments.length > 3 &&
            ((e.style.left = s + "px"), (e.style.top = a + "px"));
      }),
        ...
        (this._obj.onselectstart = function (e) {
          ...
          (this._obj.oncontextmenu = function (e) {
            var t = e || event,
              ...
              s = scheduler.callEvent("onContextMenu", [
      ...
      (scheduler._click = {
        dhx_cal_data: function (e) {
          ...
          if (i && scheduler.config.select) {
            ...
            var s = t.className;
            -1 != s.indexOf("_icon") &&
              scheduler._click.buttons[s.split(" ")[1].replace("icon_", "")](i);
          } else
            scheduler._close_not_saved(),
      ...
      (scheduler.addEventNow = function (e, t, i) {
        var s = {};
        e &&
          null !== e.constructor.toString().match(/object/i) &&
          ((s = e), (e = null));
        var a = 6e4 * (this.config.event_duration || this.config.time_step);
        e ||
          (e =
            s.start_date ||
            Math.round(scheduler._currentDate().valueOf() / a) * a);
        var n = new Date(e);
        if (!t) {
      ...
      (scheduler._mouse_coords = function (e) {
        ...
        if (a) t = a.call(this, t);
          ...
          for (
            r = 1;
            r < this._colsS.heights.length && !(this._colsS.heights[r] > t.y);
            r++
          );
          (t.y = Math.ceil(
            (24 * (Math.max(0, n) + 7 * Math.max(0, r - 1)) * 60) /
              this.config.time_step
          )),
            (scheduler._drag_mode || "month" == this._mode) &&
              (t.y =
                (24 *
                  (Math.max(0, Math.ceil(n) - 1) + 7 * Math.max(0, r - 1)) *
                  60) /
                this.config.time_step),
      ...
      (scheduler._is_pos_changed = function (e, t) {
        ...
        return !!(
          ...
          t.timestamp - this._drag_pos.timestamp > s ||
          i(e.ev.clientX, t.ev.clientX, a) ||
          i(e.ev.clientY, t.ev.clientY, a)
        );
      }),
      ...
      (scheduler._correct_drag_end_date = function (e, t) {
        ...
        return new Date(
          1 * s - (scheduler._get_fictional_event_length(s, -1, i, -1) + 1)
        );
      }),
          ...
          if (this._is_pos_changed(this._drag_pos, t)) {
            ...
            if (
              ...
              ("day" != this._mode && "week" != this._mode) ||
                ...
                (r = new Date(this._drag_start + 1e3)),
            ...
            if (
              (scheduler.matrix && (d = scheduler.matrix[scheduler._mode]),
              (d = d || { x_step: 1, x_unit: "day" }),
              "move" == this._drag_mode)
            )
              (i =
                ...
                t._ignores && this.config.preserve_length && this._table_view
                  ? ((i = scheduler._correct_drag_start_date(i)),
                    (s = scheduler._correct_drag_end_date(
                      i,
                      this._drag_event._event_length
                    )))
                  : (s = o.end_date.valueOf() - (o.start_date.valueOf() - i));
            else {
              if (
                ...
                if ("month" == this._mode)
                  if (
                    ((l = this._correct_shift(l, !1)), this._drag_from_start)
                  ) {
                    var h = 864e5;
                    l <=
                      scheduler.date.date_part(new Date(s + h - 1)).valueOf() &&
                      (i = l - h);
                  } else s = l;
                else
                  t.resize_from_start
                    ? (i = scheduler._correct_drag_start_date(l))
                    : (s = scheduler._correct_drag_end_date(l, 0));
              } else {
                var _ = this.date
                ...
                (s = _ + t.y * this.config.time_step * 6e4),
                  (s +=
                    6e4 *
                    (new Date(s).getTimezoneOffset() - c.getTimezoneOffset())),
                  (this._els.dhx_cal_data[0].style.cursor = "s-resize"),
                  ("week" == this._mode || "day" == this._mode) &&
                    (s = this._correct_shift(s));
              }
            ...
            if (
              ...
              (+f < +scheduler._min_date || +s > +scheduler._max_date)
            ) {
              if (
                +o.start_date < +scheduler._min_date ||
                +o.end_date > +scheduler._max_date
              )
                (f = new Date(o.start_date)), (s = new Date(o.end_date));
              else {
                var v = s - f;
                +f < +scheduler._min_date
                  ? ((f = new Date(scheduler._min_date)),
                    t._ignores &&
                    this.config.preserve_length &&
                    this._table_view
                      ? ((f = new Date(scheduler._correct_drag_start_date(f))),
                        d._start_correction &&
                          (f = new Date(f.valueOf() + d._start_correction)),
                        (s = new Date(
                          1 * f +
                  ...
                  : ((s = new Date(scheduler._max_date)),
                    ...
                    this._table_view
                      ? (d._end_correction &&
                          (s = new Date(s.valueOf() - d._end_correction)),
                        (s = new Date(
                          1 * s - this._get_fictional_event_length(s, 0, d, !0)
                        )),
                        (f = new Date(
                          1 * s -
                            this._get_fictional_event_length(
                        ...
                        this._ignores_detected &&
                          ((f = scheduler.date.add(f, d.x_step, d.x_unit)),
                          (s = new Date(
                            1 * s -
                              this._get_fictional_event_length(s, 0, d, !0)
                          )),
                          (s = scheduler.date.add(s, d.x_step, d.x_unit))))
                      : (f = new Date(+s - v)));
              }
              var g = new Date(s - 1);
            }
            ...
            if (
              this._table_view ||
              (g.getDate() == f.getDate() &&
                g.getHours() < this.config.last_hour) ||
          ...
          switch (i) {
            ...
            case "dhx_event_resize":
              (this._drag_mode = "resize"),
                (t.className || "").indexOf("dhx_event_resize_end") < 0
            ...
            default:
              if (
                (!scheduler.checkEvent("onMouseDown") ||
                  scheduler.callEvent("onMouseDown", [i])) &&
                t.parentNode &&
                t != this &&
                "dhx_body" != i
              )
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  this._new_event ||
                    this.callEvent(n ? "onEventAdded" : "onEventChanged", [
                      t,
                      this.getEvent(t),
                    ]);
              else
      ...
      (scheduler.updateView = function (e, t) {
        ...
        var i = "dhx_cal_data";
        this._mode
          ? (this._obj.className = this._obj.className.replace(
              "dhx_scheduler_" + this._mode,
              "dhx_scheduler_" + t
            ))
          : (this._obj.className += " dhx_scheduler_" + t);
        var s =
        ...
        var a = "dhx_multi_day";
        this._els[a] &&
          (this._els[a][0].parentNode.removeChild(this._els[a][0]),
          (this._els[a] = null)),
          (this._mode = t),
          (this._date = e),
        ...
        if (n)
          for (var r = 0; r < n.length; r++) {
            ...
            (d = d.replace(/ active/g, "")),
              n[r].getAttribute("name") == this._mode + "_tab" &&
                (d += " active"),
              (n[r].className = d);
          }
        this.update_view(),
      ...
      (scheduler._render_x_header = function (e, t, i, s, a) {
        ...
        "month" == this._mode &&
          ...
          ((n.className += " dhx_scale_bar_border"), (t += 1)),
          this.set_xy(n, r, this.xy.scale_height - 2, t, a),
          (n.innerHTML = this.templates[this._mode + "_scale_date"](
            i,
            this._mode
          )),
          s.appendChild(n);
      ...
      (scheduler._set_scale_col_size = function (e, t, i) {
        ...
        this.set_xy(
          e,
          t - 1,
          s.hour_size_px * (s.last_hour - s.first_hour),
      ...
      (scheduler._render_scales = function (e, t) {
        ...
        for (var l = 0; d > l; l++) {
          if (
            (this._ignores[l] || this._render_x_header(l, o, r, e),
            !this._table_view)
          ) {
      ...
      (scheduler._reset_scale = function () {
        if (this.templates[this._mode + "_date"]) {
          ...
          var a,
            n,
            r = this._get_timeunit_start(),
            d = scheduler._get_view_end();
          if (
            ((a = n = this._table_view ? scheduler.date.week_start(r) : r),
            (this._min_date = a),
            (this._els.dhx_cal_date[0].innerHTML = this.templates[
              this._mode + "_date"
            ](r, d, this._mode)),
            (this._max_date = d),
      ...
      (scheduler._reset_hours_scale = function (e, t, i) {
        ...
        for (
          ...
          (r.className = "dhx_scale_hour"),
            (r.style.height =
              this.config.hour_size_px - (this._quirks ? 0 : 1) + "px");
          var d = this.xy.scale_width;
          this.config.left_border &&
            ((d -= 1), (r.className += " dhx_scale_hour_border")),
            (r.style.width = d + "px"),
      ...
      (scheduler._render_month_scale = function (e, t, i) {
        ...
        for (
          var d = Math.ceil(
              Math.round((a.valueOf() - i.valueOf()) / 864e5) / 7
            ),
            o = [],
            l = 0;
          7 >= l;
      ...
      (scheduler._reset_month_scale = function (e, t, i) {
        ...
        return (
          (this._colsS.height = r + this.xy.month_head_height),
          (this._colsS.heights = []),
      ...
      (scheduler._lame_clone = function (e, t) {
        ...
        if (e && "object" == typeof e) {
          for (
            a = {}, s = [Array, Date, Number, String, Boolean], i = 0;
            i < s.length;
            i++
          )
          ...
          for (i in e)
            Object.prototype.hasOwnProperty.apply(e, [i]) &&
              (a[i] = scheduler._lame_clone(e[i], t));
        }
        return a || e;
      }),
      ...
      (scheduler._get_real_event_length = function (e, t, i) {
        var s,
          ...
          d = 0;
        i.render
          ? ((d = this._get_date_index(i, e)), (s = this._get_date_index(i, t)))
          : (s = Math.round(a / 60 / 60 / 1e3 / 24));
        for (var o = !0; s > d; ) {
      ...
      (scheduler.date = {
        ...
        str_to_date: function (e, t) {
          ...
          var r = new Function(
            "date",
            "var set=[0,0,1,0,0,0]; " + i + " return new Date(" + n + ");"
          );
      ...
      (scheduler.addEvent = function (e, t, i, s, a) {
        ...
        1 != arguments.length &&
          ...
          (n.text = n.text || ""),
          "string" == typeof n.start_date &&
            (n.start_date = this.templates.api_date(n.start_date)),
          "string" == typeof n.end_date &&
            (n.end_date = this.templates.api_date(n.end_date));
        var r = 6e4 * (this.config.event_duration || this.config.time_step);
        n.start_date.valueOf() == n.end_date.valueOf() &&
          n.end_date.setTime(n.end_date.valueOf() + r),
        ...
        return (
          ...
          this._loading ||
            this.callEvent(d ? "onEventAdded" : "onEventChanged", [n.id, n]),
          n.id
        );
      }),
      ...
      (scheduler._render_month_link = function (e) {
        for (
          var t = this._rendered_location, i = this._lame_clone(e), s = e._sday;
          s < e._eday;
          s++
        ) {
            ...
            if (r.rows) {
              for (var d = 0; d < r.rows.length; d++) {
                ...
                if (a[d] * i > l) {
                  ...
                  a[d] <= this.config.max_month_events
                    ? (h = a[d] * i)
              ...
              if (
                (a.unshift(0),
                r.parentNode.offsetHeight < r.parentNode.scrollHeight &&
              ...
              (x.style.height = m),
                ...
                (a[0] = 0),
                v != f &&
                  ((n.style.top = parseInt(n.style.top) + 2 + "px"),
      ...
      (scheduler._get_event_sday = function (e) {
        return Math.floor(
          (e.start_date.valueOf() - this._min_date.valueOf()) / 864e5
        );
      }),
            ...
            if (0 !== this.xy.menu_width && this._select_id == e.id) {
              ...
              for (
                var m =
                  ...
                  p = "",
                  x = e.color ? "background-color: " + e.color + ";" : "",
                  b = e.textColor ? "color: " + e.textColor + ";" : "",
                  y = 0;
                y < m.length;
                y++
              )
                p +=
                  ...
                  b +
                  "' title='" +
                  this.locale.labels[m[y]] +
                  "'></div>";
              var w = this._render_v_bar(
                e,
                h - t + 1,
                n,
                t,
                20 * m.length + 26 - 2,
                "",
                "<div style='" + x + b + "' class='dhx_menu_head'></div>",
                p,
                !0
              );
              (w.style.left = h - t + 1),
      ...
      (scheduler.getEvents = function (e, t) {
        ...
        for (var s in this._events) {
          ...
          a &&
            ((!e && !t) || (a.start_date < t && a.end_date > e)) &&
            i.push(a);
        }
        return i;
      }),
          ...
          if (
            ...
            d &&
              (scheduler._els.dhx_cal_data[0].scrollTop =
                getAbsoluteTop(d) -
                getAbsoluteTop(scheduler._els.dhx_cal_data[0]) -
                20);
          }
      ...
      (scheduler._append_drag_marker = function (e) {
        if (!e.parentNode) {
          var t = scheduler._els.dhx_cal_data[0],
            i = t.lastChild;
          i.className &&
            i.className.indexOf("dhx_scale_holder") < 0 &&
            i.previousSibling &&
            (i = i.previousSibling),
            i &&
              0 === i.className.indexOf("dhx_scale_holder") &&
              i.appendChild(e);
        }
      }),
            ...
            for (var a = !0; i < this._max_date; )
              (i = this.date.add(i, 1, this._load_mode)),
                this._loaded[s(t)] && a
                  ...
                  : (a = !1);
            var n = i;
            do (i = n), (n = this.date.add(i, -1, this._load_mode));
            while (n > t && this._loaded[s(n)]);
            if (t >= i) return !1;
            for (
              dhtmlxAjax.get(e + "&from=" + s(t) + "&to=" + s(i), function (e) {
                scheduler.on_load(e);
              });
              i > t;
      ...
      (scheduler._xmlNodeToJSON = function (e) {
        ...
        for (var i = 0; i < e.childNodes.length; i++) {
          ...
          1 == s.nodeType &&
            (t[s.tagName] = s.firstChild ? s.firstChild.nodeValue : "");
        }
        return (
      ...
      (scheduler.ical = {
        ...
        parse_param: function (e, t) {
          ...
          if (-1 != i) {
            ...
            "summary" == s
              ? (s = "text")
              : "dtstart" == s
              ? ((s = "start_date"), (a = this.parse_date(a, 0, 0)))
              : "dtend" == s &&
                ((s = "end_date"), (a = this.parse_date(a, 0, 0))),
              (t[s] = a);
          }
        },
        parse_date: function (e, t, i) {
          ...
          var a = s[0].substr(0, 4),
            ...
            r = s[0].substr(6, 2);
          return scheduler.config.server_utc && !s[1]
            ? new Date(Date.UTC(a, n, r, t, i))
            : new Date(a, n, r, t, i);
        },
      ...
      (scheduler.form_blocks = {
        ...
        select: {
          ...
          set_value: function (e, t, i, s) {
            ...
            !a._dhx_onchange &&
              s.onchange &&
              ((a.onchange = s.onchange), (a._dhx_onchange = !0)),
        ...
        time: {
          render: function (e) {
            ...
            return (
              "<div style='height:30px;padding-top:0px;font-size:inherit;' class='dhx_section_time'>" +
              r +
              ...
              for (
                var c = function () {
                    (n = new Date(
                      ...
                      (r = new Date(
                        n.getTime() + 60 * scheduler.config.event_duration * 1e3
                      )),
                      a(o, 4, r);
                  },
                  u = 0;
      ...
      (scheduler.showCover = function (e) {
        if (e) {
          ...
          t
            ? (e.style.top =
                Math.round(t + Math.max((s - e.offsetHeight) / 2, 0)) + "px")
            : (e.style.top =
                Math.round(Math.max((s - e.offsetHeight) / 2, 0) + 9) + "px"),
      ...
      (scheduler._fill_lightbox = function (e, t) {
        ...
        scheduler.templates.lightbox_header
          ? ((s[1].innerHTML = ""),
            (s[2].innerHTML = scheduler.templates.lightbox_header(
              i.start_date,
              i.end_date,
              i
            )))
          : ((s[1].innerHTML = this.templates.event_header(
              i.start_date,
              i.end_date,
              i
            )),
            ...
            switch (t.className) {
              ...
              default:
                if (t.getAttribute("dhx_button"))
                  ...
                  var s, a, n;
                  -1 != t.className.indexOf("dhx_custom_button") &&
                    (-1 != t.className.indexOf("dhx_custom_button_")
      ...
      (scheduler.getLightbox = function () {
        if (!this._lightbox) {
          ...
          for (
            ...
            t +=
              "<div class='dhx_btn_set dhx_left_btn_set " +
              i[s] +
          ...
          for (var s = 0; s < i.length; s++)
            t +=
              "<div class='dhx_btn_set dhx_right_btn_set " +
              i[s] +
          ...
          for (var s = 0; s < a.length; s++) {
            ...
            if (n) {
              ...
              a[s].button &&
                (r =
                  "<div class='dhx_custom_button' index='" +
                  s +
            ...
            (scheduler.render_view_data = function () {
              for (
                var e = scheduler.getState().drag_id,
                  ...
                  s = i.y_property,
                  a = scheduler.getEvents(t.start_date, t.end_date),
                  n = 0;
                n < a.length;
                n++
              )
                a[n][s] != t[s] && (a.splice(n, 1), n--);
            ...
            s &&
              (i =
                ...
                (s._timed
                  ...
                  : scheduler.templates.day_date(s.start_date, s.end_date, s)) +
                "</div>");
          }
            ...
            for (var a in t)
              0 !== a.indexOf("_") &&
                (t[a] && t[a].getUTCFullYear
                  ? (i[s + a] = this.obj.templates.xml_format(t[a]))
                  : t[a] && "object" == typeof t[a]
                  ? e._objToJson(t[a], i, s + a + ".")
                  : (i[s + a] = t[a]));
            return i;
          }),
          ...
          a && (a.padding = 14),
            ...
            scheduler.attachEvent("onTemplatesReady", function () {
              ...
              if (
                    ...
                    return (
                      1 == i.getDate() &&
                        (s =
                          ...
                          " " +
                          s),
                      +i == +scheduler.date.date_part(new Date()) &&
                        (s =
                ...
                for (
                  var i =
                      scheduler._els.dhx_cal_navline[0].getElementsByTagName(
                        "div"
                      ),
                    s = null,
                    a = 211,
                  ...
                  if (d)
                    ...
                    0 === (r.className || "").indexOf("dhx_minical_icon") &&
                      r.parentNode == scheduler._els.dhx_cal_navline[0] &&
                      (s = r);
                }
                s && (s.style.left = a + "px");
              }
        ...
        !(function (e) {
          ...
          e.fn.dhx_scheduler = function (s) {
            ...
            return i[s]
              ? i[s].apply(this, [])
              : void e.error(
                  "Method " + s + " does not exist on jQuery.dhx_scheduler"
                );
          };
        })(jQuery),
      (function () {
          ...
          n = function (t, n) {
            ...
            window.clearTimeout(a),
              ...
              (a = setTimeout(function () {
                r.callEvent("onBeforeViewChange", [
                  r._mode,
                  r._date,
                  n || r._mode,
                  t || r._date,
        ...
        scheduler.attachEvent("onSchedulerReady", function () {
          scheduler.config.delay_render
            ? ((scheduler.setCurrentView = n), (scheduler.updateView = r))
  ...
  dhtmlx &&
    dhtmlx.attaches &&
    (dhtmlx.attaches.attachScheduler = function (e, t, i, s) {
      var i =
          i ||
